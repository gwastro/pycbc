...
curl https://code.pycbc.phy.syr.edu/detchar/veto-definitions/download/master/cbc/O1/${VETO_DEF_NAME}
...
${RUN_DIR}/pycbc_make_coinc_search_workflow --workflow-name ${WORKFLOW_NAME} --output-dir ${OUTPUT_DIR} \
    --config-files \
      ...
      https://code.pycbc.phy.syr.edu/ligo-cbc/pycbc-config/blob/a9d35a4b17fa9e62ff822ddffca9c2820b007d92/O1/pipeline/gps_times_O1_analysis_9.ini \
...
cd ${OUTPUT_DIR}
${RUN_DIR}/pycbc_submit_dax --accounting-group ligo.dev.o1.detchar.singleifo.dailyahope --dax ${WORKFLOW_NAME}.dax

# update the nagios monitor
NAGIOS_GPS_TIME=`lalapps_tconvert`
NAGIOS_FILE=/home/${USER}/public_html/daily_cbc_offline/nagios/nagios-workflow-generator.json
