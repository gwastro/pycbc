...
# source code
source /home/cbc/lalsuite/master_20141023_cd984/etc/lscsoftrc
source /home/cbc/pycbc/master_20141023_ffc8d/etc/pycbc-user-env.sh

# source detchar
source /home/detchar/opt/gwpysoft/etc/gwpy-user-env.sh

# move to run dir
DIR=/home/cbc/daily_ahope_er5
cd ${RUNDIR}
