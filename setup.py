...
pycbc_extensions.append(Extension( 'pycbc.straindata.clayer._straindatacpu',
    ...
    include_dirs =  pycbc_include_dirs +  ['pycbc/clayer/cpu','pycbc/datavector/clayer/cpu','pycbc/datavector/clayer','pycbc/clayer'],
...
pycbc_sources += ['pycbc/waveformgenerator/clayer/cpu/waveformgeneratorcpu.c']
pycbc_extensions.append(Extension( 'pycbc.waveformgenerator.clayer._waveformgeneratorcpu', 
