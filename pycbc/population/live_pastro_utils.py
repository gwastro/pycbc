...
def insert_live_pastro_option_group(parser):
    ...
    live_pastro_group.add_argument(
        "--p-astro-spec",
...
_check_spec = {
    ...
    "template_param_bins_types_farlim": livepa.check_template_param_bin_farlim_data,
}
...
_do_calc = {
    ...
    "template_param_bins_types_farlim": livepa.template_param_bin_types_farlim_pa,
}
...
class PAstroData:
    ...
    def __init__(self, specfile, bank):
        ...
        if specfile is None:
            ...
            try:
                ...
                raise ValueError("Can't find 'method' in p_astro spec file!") from ke
    ...
    def apply_significance_limits(self, trigger_data):
        ...
        if len(trigger_data["triggered"]) > 1:
            ...
            logger.debug(
                "Truncating FAR and SNR from %f, %f to %f, %f",
                trigger_data["far"],
                trigger_data["network_snr"],
                farlim,
                snrlim,
            )
...
__all__ = ["PAstroData", "insert_live_pastro_option_group"]
