...
def get_beta_sigma_from_aligned_spins(mass,eta,spin1z,spin2z):
    """
    Obtain the various PN spin combinations from the masses and spins

    Parameters
    -----------
    mass : float or numpy.array
        Total mass(es) of the input system(s)
    eta : float or numpy.array
    ...
    spin2z : float or numpy.array
        Spin(s) parallel to the orbit of the smalliest body(ies)
