...
def get_chirp_params_newer(mass1, mass2, spin1z, spin2z, f0, order,
...
get_chirp_params_newer.__doc__ = \
    get_chirp_params_newer.__doc__.format(pycbcValidOrdersHelpDescriptions)
...
get_chirp_params = get_chirp_params_newer
