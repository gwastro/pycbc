...
class CalculatePSDVariation():
    """ Calculates the PSD variation of the strain data and assigns a 
    value associated to the variation to triggers
    """
    #nam = "calculate_psd_variation"
    #_inputs = []
    #_outputs = []
    ...
    def calc_psd_variation(strain, psd_short_segment=4., 
        ...
        psd_var = pycbc.types.TimeSeries(pycbc.types.zeros(
                      int((strain.end_time - strain.start_time) / 
