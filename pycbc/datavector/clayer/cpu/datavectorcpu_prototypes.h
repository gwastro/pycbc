...
real_vector_single_t* new_real_vector_single_t(unsigned long);
void delete_real_vector_single_t( real_vector_single_t* );

real_vector_double_t* new_real_vector_double_t(unsigned long);
void delete_real_vector_double_t( real_vector_double_t* );

complex_vector_single_t* new_complex_vector_single_t(unsigned long);
void delete_complex_vector_single_t( complex_vector_single_t* );

complex_vector_double_t* new_complex_vector_double_t(unsigned long);
