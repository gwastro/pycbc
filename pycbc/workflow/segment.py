...
def get_veto_segs(workflow, out_dir, science_veto_name='segments-science-veto',
...
def get_cumulative_veto_group_files(workflow, option, out_dir, tags=None):
    """
