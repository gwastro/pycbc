// Copyright (C) 2011 Duncan Brown, Karsten Wiesner, Drew Keppel
//
...
typedef struct {
    ...
    double ph7;
    double ph8;
} pycbc_taylorf2_pnconstants;

static void taylorf2_phase_engine(
    complex_vector_single_cpu_t* exp_psi,
    const double M,
    const pycbc_taylorf2_pnconstants pn_consts,
    double f_min,
    double f_max,
...
static void taylorf2_precondition_factor(
    real_vector_single_cpu_t* vec
    )
{
...
{
    pycbc_taylorf2_pnconstants pn_consts;
    memset(&pn_consts, 0, sizeof(pycbc_taylorf2_pnconstants));
    ...
    taylorf2_phase_engine(exp_psi, M, pn_consts, f_min, f_max, minus_one_by_three);
}
