...
#pycbc_swig_sources = ['lib/datavector/clayer/cpu/datavectorcpu.i']
#pycbc_c_sources = ['lib/datavector/clayer/cpu/datavectorcpu.c']
...
datavectorcpu_ext = Extension( '_datavectorcpu', 
  sources = ['lib/datavector/clayer/cpu/datavectorcpu.i','lib/datavector/clayer/cpu/datavectorcpu.c'],
  #depends = ['lib/datavector/clayer/cpu/'],
  swig_opts = [],
  include_dirs = ['lib/datavector/clayer/cpu/','lib/datavector/clayer/'],
...
matchedfiltercpu_ext = Extension( '_matchedfiltercpu', 
  sources = ['lib/matchedfilter/clayer/cpu/matchedfiltercpu.i','lib/matchedfilter/clayer/cpu/matchedfiltercpu.c'],
  #depends = ['lib/matchedfilter/clayer/cpu/'],
  swig_opts = [],
  include_dirs = ['lib/matchedfilter/clayer/cpu/','lib/matchedfilter/clayer/'],
  define_macros=[('TESTMACRO', '1')],
  undef_macros=['TESTMACRO'],
  extra_compile_args = ['-Wall'],
  library_dirs = [],
...
setup (name = 'pycbc',
  ...
  author_email = 'pycbc.xxxxxxxxxxx.org',
  cmdclass = {
    'config' : pycbc_config, 
    'build' : pycbc_build, 
