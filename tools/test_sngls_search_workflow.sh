...
UUID=`uuidgen`
WORKFLOW_NAME=test-sngls-workflow-$UUID
OUTPUT_PATH=`pwd`/public_html/test_sngls_workflow/${WORKFLOW_NAME}
...
--config-files \
/pycbc/examples/singles_search/analysis.ini \
/pycbc/examples/singles_search/plotting.ini \
/pycbc/examples/singles_search/injections_minimal.ini \
/pycbc/examples/singles_search/executables.ini \
--config-overrides \
